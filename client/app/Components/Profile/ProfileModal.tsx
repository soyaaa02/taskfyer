...
function ProfileModal() {
  ...
  return (
    <div className="fixed left-0 top-0 z-50 h-full bg-[#333]/30 overflow-hidden">
      <div
       ref={ref}
       className="py-5 px-6 max-w-[520px] w-full flex flex-col gap-3 bg-white absolute top-1/2 left-1/2 transform -translate-x-1/2 rounded-lg shadow-md border-2 border-white"
      >
        ...
        <div className="mt-4 relative flex justify-between">
          ...
          <Image
            ...
            />
            <div className="absolute bottom-0 right-1 shadow">
          ...
          <div className="self-end flex items-center gap-2">
            <button className="flex items-center gap-2 border-2 border-[#323232]/10 rounded-md py-1 px-3 tex-xs font-medium text-[#323232]">
            {github} Github
            </button>
            <button className="flex items-center gap-2 border-2 border-[#323232]/10 rounded-md py-1 px-3 tex-xs font-medium text-[#323232]">
            {check} Verified
        ...
        >
          ...
          <div className="pt-4 grid-cols-2 gap-4 border-t-2 border-t-[#323232]/10">
          ...
          <button
            type="submit"
            className="mt-3 py-2 px-4 bg-red-600 text-white text-sm font-medium rounded-md
                hover:bg-[#EB4E31]/90 transition-all duration-300"
          >
            Save Changes
          </button>
          </div>
